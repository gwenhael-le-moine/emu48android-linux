...
EXTERN_C DECLSPEC BOOL CALLBACK EmuCreate( LPCTSTR lpszFilename ); // @parm String with RAM filename
...
EXTERN_C DECLSPEC BOOL CALLBACK EmuCreateEx( LPCTSTR lpszFilename,    // @parm String with RAM filename
...
EXTERN_C DECLSPEC HACCEL CALLBACK EmuAcceleratorTable( HWND* phEmuWnd ); // @parm return of emulator window handle
...
EXTERN_C
    DECLSPEC VOID CALLBACK EmuCallBackClose( VOID( CALLBACK* EmuClose )( VOID ) ); // @parm CallBack function notify caller Emu48 closed
...
EXTERN_C DECLSPEC BOOL CALLBACK EmuLoadRamFile( LPCTSTR lpszFilename ); // @parm String with RAM filename
...
EXTERN_C DECLSPEC BOOL CALLBACK EmuLoadObject( LPCTSTR lpszObjectFilename ); // @parm String with object filename
...
EXTERN_C DECLSPEC BOOL CALLBACK EmuSaveObject( LPCTSTR lpszObjectFilename ); // @parm String with object filename
...
EXTERN_C DECLSPEC VOID CALLBACK EmuSimulateKey( BOOL bKeyState, // @parm TRUE = pressed, FALSE = released
...
EXTERN_C DECLSPEC VOID CALLBACK EmuPressOn( BOOL bKeyState ); // @parm TRUE = pressed, FALSE = released
...
EXTERN_C DECLSPEC BOOL CALLBACK EmuInitLastInstr( WORD wNoInstr,     // @parm number of saved instructions,
...
EXTERN_C DECLSPEC BOOL CALLBACK EmuGetLastInstr( WORD* pwNoEntries ); // @parm return number of valid entries in array
...
EXTERN_C DECLSPEC VOID CALLBACK EmuRunPC( DWORD dwAddressPC ); // @parm breakpoint address
...
EXTERN_C DECLSPEC VOID CALLBACK
    EmuCallBackDebugNotify( VOID( CALLBACK* EmuDbgNotify )( INT nBreaktype ) ); // @parm CallBack function notify Debug breakpoint
...
EXTERN_C DECLSPEC VOID CALLBACK
    EmuCallBackStackNotify( BOOL( CALLBACK* EmuStackNotify )( VOID ) ); // @parm CallBack function notify stack changed
...
EXTERN_C DECLSPEC DWORD CALLBACK EmuGetRegister( UINT uRegister ); // @parm index of register
...
EXTERN_C DECLSPEC VOID CALLBACK EmuSetRegister( UINT uRegister,  // @parm index of register
...
EXTERN_C DECLSPEC VOID CALLBACK EmuGetMem( DWORD dwMapAddr,  // @parm mapped address of Saturn CPU
...
EXTERN_C DECLSPEC VOID CALLBACK EmuSetMem( DWORD dwMapAddr, // @parm mapped address of Saturn CPU
...
EXTERN_C DECLSPEC LPBYTE CALLBACK EmuGetRom( DWORD* pdwRomSize ); // @parm return size of ROM in nibbles
...
EXTERN_C DECLSPEC BOOL CALLBACK EmuSetBreakpoint( DWORD dwAddress,        // @parm breakpoint address to set
...
EXTERN_C DECLSPEC BOOL CALLBACK EmuClearBreakpoint( DWORD dwAddress,        // @parm breakpoint address to clear
...
EXTERN_C DECLSPEC VOID CALLBACK EmuEnableNop3Breakpoint( BOOL bEnable ); // @parm stop on NOP3 opcode
...
EXTERN_C DECLSPEC VOID CALLBACK EmuEnableDoCodeBreakpoint( BOOL bEnable ); // @parm stop on DOCODE entry
...
EXTERN_C DECLSPEC VOID CALLBACK EmuEnableRplBreakpoint( BOOL bEnable ); // @parm stop on RPL exit
...
EXTERN_C DECLSPEC VOID CALLBACK EmuEnableSkipInterruptCode( BOOL bEnable ); // @parm TRUE = skip code instructions
