 ...
 *
 *   Copyright (C) 2012 Christoph Giesselink
 *
 */
#include "pch.h"
#include "emu48.h"
...
enum MEM_MAPPING GetMemMapType( VOID ) { return eMapType; }
...
BOOL GetMemAvail( enum MEM_MAPPING eType )
{
    switch ( eType ) {
        case MEM_MMU:
            return TRUE;
        case MEM_NCE1:
            return *pMapping->ppbyNCE1 != NULL;
        case MEM_NCE2:
            return *pMapping->ppbyNCE2 != NULL;
        case MEM_CE1:
            return *pMapping->ppbyCE1 != NULL;
        case MEM_CE2:
            return *pMapping->ppbyCE2 != NULL;
        case MEM_NCE3:
            return *pMapping->ppbyNCE3 != NULL;
        default:
            _ASSERT( FALSE );
    }
    return FALSE;
...
DWORD GetMemDataSize( VOID ) { return dwMapDataSize; }

DWORD GetMemDataMask( VOID ) { return dwMapDataMask; }
