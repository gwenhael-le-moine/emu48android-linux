 ...
 *
 *   Copyright (C) 2011 Christoph Giesselink
 *
 */
#include "pch.h"
#include "emu48.h"
...
static SOCKADDR_IN sServer = {
    AF_INET, 0, { 255, 255, 255, 255 }
};
...
BOOL SendByteUdp( BYTE byData )
{
    ...
    if ( sServer.sin_addr.s_addr == INADDR_NONE ) {
        ...
        WideCharToMultiByte( CP_ACP, WC_COMPOSITECHECK, szUdpServer, dwLength, lpszIpAddr, dwLength, NULL, NULL );
#else
